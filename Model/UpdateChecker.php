...
class UpdateChecker
{
    private const PACKAGE     = 'etechflow/module-mega-menu';
    private const LATEST_URL  = 'https://license-service.etechflow.com/composer/latest/etechflow/module-mega-menu.json';
    private const CACHE_KEY   = 'etechflow_mm_update_check';
    private const CACHE_TTL   = 21600;
    private const MODULE_NAME = 'Etechflow_MegaMenu';
